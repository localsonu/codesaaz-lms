...
import {LeaverequestEmployeeComponent} from '../leaverequest-contents/leaverequest-employee/leaverequest-employee.component';
import {LeaverequestEmployeeMainComponent} from '../leaverequest-contents/leaverequest-employee-main/leaverequest-employee-main.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'employeeleaves',
        component: LeaverequestEmployeeMainComponent,
        children: [
          {path: '', redirectTo: 'details', pathMatch: 'full'},
          {path: 'details', component: LeaverequestEmployeeComponent},
          {path: 'details/:id', component: LeaverequestEmployeeComponent},
          {path: 'new', component: LeaverequestManageComponent}
        ]
      },
      {
